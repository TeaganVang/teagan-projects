namespace People
{
    ...
    public class Relation
    {
        ...
        {
            Console.WriteLine($"Garrett Ward Armstrong Magee is my {Relationship}. It is {CollegeStudent.ToString().ToLower()} that he is a freshman at KU. The last time we met was {LastMeeting.ToShortDateString()}");
        }
    }
} 